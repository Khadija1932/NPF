...
- NPF.ipynp contains a section 'LFP' that describe the structure of the dataset and how to transform it. This section can be ignored if you are running the notebook with synthetic observations.
